...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to CodeIgniter by Osvaldo Zunniga <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>The small framework created by powerful programmer
                <a href="https://github.com/OsvaldoZunniga">@OsvaldoZunniga</a>        
        </h2>
